...
const PrivacyNote: React.FunctionComponent<PrivacyNoteType> = (props) => {
  ...
  return (
    <>
      <Col xs={12} md={12} className="mt-5" style={{ fontWeight: "normal" }}>
        <p className="text-xl font-semibold">Standard Privacy Note</p>
        <p className="italic">
      ...
      <div className="space-y-4 md:space-y-0 md:flex">
        <Col xs={12} md={4}>
          <div className="switch">
            ...
            <Tooltip placement="bottom" isOpen={tooltip} target="TooltipExample" toggle={toggle} style={{ backgroundColor: "#FAC228", color: 'black' }}>
        ...
        <Col xs={12} md={4}>
          <div className="switch">
            <span className="mr-5">Emailing</span>
        ...
        <Col xs={12} md={4}>
          <div className="switch">
            <span className="mr-5">Mailing</span>
      ...
      <Col xs={12} md={12} className="mt-5">
        <Label check className="mb-4 text-lg font-light">
          <Input type="checkbox" className="mr-4" style={{ border: "1px solid #FAC228" }} />
          {" "}
      ...
      <Col xs={12} md={12}>
        <p className="text-lg font-semibold mt-4 mb-4 text-center">v1.0.7</p>
      </Col>
    </>
  );
};
